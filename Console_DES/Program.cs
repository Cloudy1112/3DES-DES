...
namespace Console_DES
{
    internal class Program
    {
        static void Main(string[] args)
        {
            /*Console.Write("Ban ro: ");
            string plain = Console.ReadLine();

            Console.Write("Khoa: ");
            string k = "12345678"; //Console.ReadLine(); 

            string[] enc = Encrypt_all(plain, k);
            ...
            Console.WriteLine();
            Console.WriteLine(ConvertBinary_string(dec));*/

            string k1 = "12345678";
            string k2 = "09876543";
            string k3 = "34567898";

            string plain = "Con tien may dung co ma lao nhao, t quynh m luon a coi chung";

            string cipher = Mahoa3DES(plain, k1, k2, k3);
            string banro = Giaima3DES(cipher, k1, k2, k3);

            Console.WriteLine("Ban ma: "+cipher);
            Console.WriteLine("Ban ro: " + banro);
